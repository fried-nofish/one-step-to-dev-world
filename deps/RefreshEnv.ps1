...
.PROJECTURI https://github.com/asheroto/RefreshEnv
...
.NOTES
    ...
    Created by : asheroto
.LINK
    Project Site: https://github.com/asheroto/RefreshEnv
#>
[CmdletBinding()]
param (
    [switch]$Version,
...
Export-ModuleMember -Function Update-SessionEnvironment
